CKEDITOR.plugins.add( 'border', {
  ...
  init: function( editor ) {
    var borderouter = ( editor.config.borderTypeList || [ 'border_bottom:Inferior:border-bottom:1px solid black',
                                                          'border_top:Superior:border-top:1px solid black',
                                                          'border_right:Direita:border-right:1px solid black',
                                                          'border_left:Esquerda:border-left:1px solid black',
                                                          'border_double_bottom:Inferior Dupla:border-bottom:3px double black'] ),
      plugin = this,
      items = {},
      parts,
      curBorderType,
